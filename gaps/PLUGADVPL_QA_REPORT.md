# Relatório QA — plugadvpl 0.3.14

**Data:** 2026-05-14
**Projeto-base:** `D:\Projetos\CLIENTE_X` (1.992 fontes ADVPL/TLPP indexados)
**Versões:** `runtime_version=0.3.14`, `schema_version=4`, `parser_version=p1.0.0`
**Dicionário SX:** ingerido (`tabelas=11.264`, `campos=187.633`, `gatilhos=18.051`, `parametros=18.435`, etc.)
